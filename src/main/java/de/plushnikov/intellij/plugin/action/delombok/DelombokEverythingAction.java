...
public class DelombokEverythingAction extends AbstractDelombokAction {
  ...
  protected DelombokHandler createHandler() {
    return new DelombokHandler(true,
      ...
      ApplicationManager.getApplication().getService(JresDataProcessor.class),
      ...
      ApplicationManager.getApplication().getService(JresEqualsAndHashCodeProcessor.class),
      ApplicationManager.getApplication().getService(JresToStringProcessor.class),
