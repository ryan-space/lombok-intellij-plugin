...
public class JresRefactorSetterHandler extends BaseRefactorHandler {

  public JresRefactorSetterHandler(Project project, DataContext dataContext) {
    ...
    for (ClassMember classMember : classMembers) {
      ...
      if (null != psiMethod) {
        ...
        if (null != modifierList) {
          PsiAnnotation psiAnnotation = modifierList.addAnnotation(JRESSetter.class.getName());
